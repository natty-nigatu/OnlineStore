    ...
    if ($type != 1) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["edit"])) {
                ...
                $category->id = $_POST["edit"];
                $category->read();

            }else if (isset($_POST["add_cat"])){
                $category = new Category();
                $category->id = $_POST["add_cat"];
                $category->read();
            ...
            <div class="products">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="./edit_category.php" method="post" class="add-category">
                            <label for="cat_name">Category name</label>
                            <input type="text" name="cat_name" id="cat_name" value="<?php echo $category->name ?>">
                            <button style="float:none;" type="submit" name="add_cat" id="add_cat" value="<?php echo $category->id ?>"> Update </button>
