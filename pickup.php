...
<body class="body-margin">
    ...
    <div class="nav-container">
        <nav class="navbar navbar-expand-sm fixed-top bg-black drop-shadow navbar-dark">
            ...
            <ul class="navbar-nav mx-auto main-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="pickup.php">PICK UP</a>
                </li>
    ...
    <div class="cart-header bg-green float-shadow">
        <span class="color-white" style="font-size: 20px;">Orders Ready To Be Picked Up</span>
    </div>

    <?php

    $orders = Common::get_orders_for_pickup();
    foreach ($orders as $o) {
    ...
    ?>
        ...
        <form action="pickup.php" method="POST">
            <div class="delivery-item-container float-shadow">
                ...
                <button type="submit" name="id" value="<?php echo $o->id ?>" class="btn btn-outline-success btn-product">Pick Up</button>
            </div>
        </form>
